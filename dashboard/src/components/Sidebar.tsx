import { Shield, BarChart3, Activity, FileCode, Brain, Settings, LogOut, User } from 'lucide-react';
    ...
    return (
        <div className="w-72 bg-gradient-to-b from-slate-900 to-slate-950 border-r border-blue-500/20 flex flex-col backdrop-blur-xl">
            ...
            <div className="px-4 pt-4 pb-2">
                <div className="flex items-center space-x-3 bg-slate-800/50 border border-slate-700/50 rounded-lg px-3 py-2.5">
            ...
            <div className="p-4 space-y-3">
                <button
                    ...
                    className="w-full flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200
                        ...
                        hover:border-red-500/30 group disabled:opacity-50 disabled:cursor-not-allowed"
                >
                    <LogOut className={`w-5 h-5 transition-transform group-hover:-translate-x-0.5 ${loggingOut ? 'animate-pulse' : ''}`} />
