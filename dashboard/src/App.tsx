    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
            <div className="text-center">
                <div className="login-shield-container mx-auto mb-6" style={{ width: 80, height: 80 }}>
                ...
                <p className="text-sm text-slate-400 tracking-widest uppercase">Verifying Session...</p>
            </div>
        </div>
    );
}
...
function App() {
    ...
    const { isAuthenticated, isLoading: authLoading, verifySession } = useAuthStore();
